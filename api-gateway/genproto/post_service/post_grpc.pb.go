...
func (c *postServiceClient) DeletePost(ctx context.Context, in *PostID, opts ...grpc.CallOption) (*Post, error) {
	out := new(Post)
...
func (UnimplementedPostServiceServer) DeletePost(context.Context, *PostID) (*Post, error) {
